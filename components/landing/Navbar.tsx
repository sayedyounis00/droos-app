      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <Link href="/" className="flex items-center gap-2.5 transition-transform hover:scale-[1.02]">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-medium text-[#1F7A7B]">منصة التعلم المتكاملة</span>
          </div>
        </Link>
        ...
        <div className="hidden items-center gap-3 md:flex">
          <Link
            href="#student-login"
            className="inline-flex items-center justify-center rounded-xl border border-[#3A8DDE]/30 bg-[#3A8DDE]/5 px-4 py-2 text-sm font-medium text-[#3A8DDE] transition-all hover:bg-[#3A8DDE]/15 hover:border-[#3A8DDE]"
          >
            دخول الطالب
          </Link>
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#E8A83C] px-5 py-2 text-sm font-semibold text-white shadow-sm shadow-[#E8A83C]/25 transition-all hover:bg-[#C88A22] active:scale-[0.98]"
          >
            <span>سجّل كمعلم</span>
      ...
      {mobileMenuOpen && (
        <div className="border-t border-[#EEF0F2] bg-white px-4 pt-3 pb-6 shadow-lg md:hidden">
          <div className="flex flex-col gap-3">
            ...
            <div className="mt-3 flex flex-col gap-2.5 pt-3 border-t border-[#EEF0F2]">
              <a
                href="https://wa.me/?text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%D9%8B%D8%8C%20%D8%A3%D8%B1%D8%BA%D8%A8%20%D9%81%D9%8A%20%D8%A5%D9%86%D8%B4%D8%A7%D8%A1%20%D8%AD%D8%B3%D8%A7%D8%A8%20%D9%83%D9%85%D8%B9%D9%84%D9%85%20%D8%B9%D9%84%D9%89%20%D9%85%D9%86%D8%B5%D8%A9%20%D8%AF%D8%B1%D9%88%D8%B3"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="#student-login"
                onClick={() => setMobileMenuOpen(false)}
                className="rounded-xl border border-[#3A8DDE]/40 bg-[#3A8DDE]/5 py-3 text-center text-sm font-medium text-[#3A8DDE]"
              >
                تسجيل دخول الطالب
              </Link>
            </div>
