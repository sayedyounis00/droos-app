...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    {
      q: "هل المنصة مناسبة لجميع المواد التعليمية والتخصصات؟",
      a: "نعم، المنصة مرنة وتستوعب جميع التخصصات والمراحل والمواد الدراسية أياً كان نوع المحتوى المراد مشاركته.",
    },
    {
      q: "هل أحتاج لخبرة تقنية أو برمجة لإنشاء منصتي؟",
      a: "لا على الإطلاق! الواجهة بصلب تصميمها مبسطة وسهلة الاستخدام وتتيح لك الإدارة الكاملة في خطوات بسيطة.",
    },
  ];
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-extrabold text-[#1C2126] sm:text-4xl">
            أسئلة شائعة تهم المعلم
          </h2>
          <p className="mt-3 text-base text-[#4A5158]">
            إليك الإجابات عن أكثر الاستفسارات شيوعاً بين المعلمين الجدد.
          </p>
        </div>
