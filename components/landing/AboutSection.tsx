      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-extrabold text-[#1C2126] sm:text-4xl">
            منصة مصممة خصيصًا لتلبي تطلعات المعلم العربي
          </h2>
          <p className="mt-4 text-base leading-relaxed text-[#4A5158] sm:text-lg">
            نوفر لك منصتك التعليمية الخاصة، حيث يمكنك تنظيم موادك التعليمية، ومتابعة طلابك، وإدارة كل شيء بسهولة تامة — دون الحاجة إلى خبرة تقنية أو تكاليف برمجة باهظة.
          </p>
        </div>
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-3xl border border-[#EEF0F2] bg-white p-8 shadow-xs transition-all hover:border-[#7EB8B9] hover:shadow-md">
            ...
            <h3 className="text-xl font-bold text-[#1C2126]">منصتك التعليمية وليست متجراً</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#4A5158]">
              نظامنا مبني كـ"منصة تعليمية للمعلم" تُعنى بالتعليم الحقيقي، وليست متجراً إلكترونياً معقداً يشتت العملية التعليمية.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-[#EEF0F2] bg-white p-8 shadow-xs transition-all hover:border-[#7EB8B9] hover:shadow-md">
            ...
            <h3 className="text-xl font-bold text-[#1C2126]">تفعيل فوري عبر واتساب</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#4A5158]">
              تواصل معنا مباشرة عبر واتساب لإنشاء حسابك كمعلم وتفعيله في خطوات معدودة وبدء رفع دروسك فوراً.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-[#EEF0F2] bg-white p-8 shadow-xs transition-all hover:border-[#7EB8B9] hover:shadow-md md:col-span-2 lg:col-span-1">
            ...
            <h3 className="text-xl font-bold text-[#1C2126]">تحكم واستقلالية تامة</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#4A5158]">
              أنت صاحب القرار في تنظيم محتواك، تعديل ملفك الشخصي، وإضافة مادتك وتخصصاتك في أي وقت بحرية كاملة.
            </p>
          </div>
